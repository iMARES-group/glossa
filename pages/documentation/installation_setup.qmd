...
GLOSSA depends on several CRAN packages that will be installed automatically when you install the `glossa` R package. However, one additional package must be installed manually if you plan to generate pseudo-absences within the environmental space. For so, you must install the [`flexsdm`](https://github.com/sjevelazco/flexsdm) package from GitHub:
