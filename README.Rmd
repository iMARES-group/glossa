...
GLOSSA may not work correctly with `shiny` v1.11.0 or later due to a known compatibility issue with `shinyWidgets`. Please downgrade `shiny` to version 1.10.0.
